...
export function Button({ 
  ...
  const variantClasses = {
    ...
    outline: 'border border-gray-300 bg-white text-gray-700 hover:bg-gray-50 focus:ring-blue-500 disabled:hover:bg-white',
    ghost: 'text-gray-700 hover:bg-gray-100 focus:ring-blue-500 disabled:hover:bg-transparent'
  };
